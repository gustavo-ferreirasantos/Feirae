...
import { User, Vendor, Product, PickupWindow, Order, Notification, Review, OrderStatus } from '@/types';
...
class MemoryStore {
  ...
  createOrder(orderData: {
    ...
    this.addNotification({
      ...
      message: `${orderData.clientName} realizou o pedido #${orderNum} no valor de R$ ${totalAmount.toFixed(2)}.`,
      type: 'NEW_ORDER',
      orderId: newOrder.id,
    });
